...
export const AUTH_FILE = path.join(process.env.HOME || process.env.USERPROFILE || "~", ".mentor", "auth.json");
export function getProjectRoot() {
    return process.cwd();
}
export function getMentorDir(projectRoot) {
...
export async function ensureMentorDir(projectRoot) {
    const dirs = [
